...
impl EconomicSeriesType {
    ...
    async fn source(&self, ctx: &Context<'_>) -> Result<Option<DataSourceType>> {
        let pool = ctx.data::<econ_graph_core::database::DatabasePool>()?;
    ...
    async fn recent_data_points(
        ...
        let data_points = dsl::data_points
            ...
            .order(dsl::date.desc())
            .limit(limit as i64)
            .load::<econ_graph_core::models::DataPoint>(&mut conn)
            .await?;
...
impl From<econ_graph_core::models::search::SeriesSearchResult> for EconomicSeriesType {
    fn from(result: econ_graph_core::models::search::SeriesSearchResult) -> Self {
        Self {
...
impl From<econ_graph_core::models::DataTransformation> for DataTransformationType {
    fn from(transformation: econ_graph_core::models::DataTransformation) -> Self {
        match transformation {
            econ_graph_core::models::DataTransformation::None => DataTransformationType::None,
            econ_graph_core::models::DataTransformation::YearOverYear => {
                DataTransformationType::YearOverYear
            }
            econ_graph_core::models::DataTransformation::QuarterOverQuarter => {
                DataTransformationType::QuarterOverQuarter
            }
            econ_graph_core::models::DataTransformation::MonthOverMonth => {
                DataTransformationType::MonthOverMonth
            }
            econ_graph_core::models::DataTransformation::PercentChange => {
                DataTransformationType::PercentChange
            }
            econ_graph_core::models::DataTransformation::LogDifference => {
...
impl From<DataTransformationType> for econ_graph_core::models::DataTransformation {
    fn from(transformation: DataTransformationType) -> Self {
        match transformation {
            DataTransformationType::None => econ_graph_core::models::DataTransformation::None,
            DataTransformationType::YearOverYear => {
                econ_graph_core::models::DataTransformation::YearOverYear
            }
            DataTransformationType::QuarterOverQuarter => {
