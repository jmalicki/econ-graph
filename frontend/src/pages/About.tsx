  ...
  return (
    <Box>
        ...
        <Grid item xs={12} md={8}>
          <Paper sx={{ p: 3, mb: 3 }}>
            ...
            <Typography variant="body1" paragraph>
              EconGraph is a modern economic data visualization platform inspired by the Federal Reserve 
              Economic Data (FRED) system. While FRED provides excellent data coverage, EconGraph focuses 
              on delivering that same comprehensive data through a more intuitive, responsive, and 
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
              {technologies.map((tech, index) => (
                <Chip
                  ...
                  label={tech.name}
                  size="small"
                  color={tech.category === 'Frontend' ? 'primary' : 
                         tech.category === 'Backend' ? 'secondary' : 'default'}
                  variant="outlined"
                />
              ))}
            </Box>
      ...
      <Box sx={{ mt: 6, py: 3, borderTop: 1, borderColor: 'divider', textAlign: 'center' }}>
        <Typography variant="body2" color="text.secondary">
          EconGraph is an independent project and is not affiliated with the Federal Reserve Bank of St. Louis or FRED.
        </Typography>
